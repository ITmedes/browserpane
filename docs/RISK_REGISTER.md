...
| R-010 | Platform failures and saturation are not yet observable end to end through standard telemetry/SLOs. | High | High | #178 | Gateway OpenMetrics RED/runtime-capacity foundation merged through PR #222; #227 locally qualifies bounded W3C/OTLP gateway-to-runtime-broker browser lifecycle traces and collector outage recovery. Worker/store/event coverage, broader subsystem metrics, alerts, runbooks, and load evidence remain. | Phase 1 / Production |
