...
| 15. Missing resource catalogs except session templates | `#159` Add admin-new catalogs for extensions, credential bindings, and workflow event subscriptions | Implemented on `feature/BPANE-00159` and under review; `IMPLEMENTATION_WORK_ORDER.md`, `ADMIN_NEW_MANUAL_CHECKPOINTS.md`, `RESOURCE_LIFECYCLE_REQUIREMENTS.md`; session templates remain `#124` |
...
| Active Operator Product work | `#154` in progress | Follow `BPANE-00154_WORKFLOW_RUN_DETAIL_PLAN.md`; preserve `/runs` compatibility while adding canonical route-backed workflow-run inspection. |
