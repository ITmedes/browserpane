...
| 14. API companion, coverage, and docs routes | `#158` Add admin-new API companion, coverage, and docs routes | Implemented on `feature/BPANE-00158`; `IMPLEMENTATION_WORK_ORDER.md`, `NEXT_WORKING_ROADMAP.md`, `ADMIN_NEW_API_COVERAGE.md` |
