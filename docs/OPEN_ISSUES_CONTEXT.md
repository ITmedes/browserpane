...
- open issue range: `#6` through `#184`,
...
- `#151` and `#173` are implemented and closed; `#184` is the active bounded
  Foundation maintenance slice,
...
| `BPANE-00184_COMPOSE_VALIDATION_PERFORMANCE_PLAN.md` | `#184`, active Foundation validation-performance slice |
...
| Foundation validation performance | `#184` | Complete the bounded hosted sharding and record measured timing evidence. |
