...
Last verified: 2026-08-22 for the #265 gateway enforcement slice based on
`main` at `b537e0c0`
...
| BrowserPane remote protocol | Prototype | Normative v1 contract; schema-v2 66-case shared corpus; byte-identical Rust/TypeScript negotiation codecs and selector; authenticated gateway-side pre-runtime negotiation, capability/direction enforcement, v1 readiness normalization, typed rejection metrics, and explicit checked-client legacy overlap | #266-#268 browser enforcement, fuzzing, and compatibility qualification under #175 |
...
- The custom protocol, BrowserPane-specific v1 contract, negotiation codecs,
  selector, shared corpus, and gateway-side enforcement are implemented, but
  browser enforcement, broad compatibility, or standard claims require the
  remaining #266-#268 work under #175.
