...
| Platform telemetry and SLOs | Partial prototype | Gateway OpenMetrics HTTP RED and aggregate runtime-capacity metrics merged through PR #222; W3C/OTLP gateway-to-runtime-broker browser lifecycle traces merged through PR #228; #229 adds shared label-free workflow, event-delivery, recording, playback, and retention counters | #178 broader worker/store tracing and metrics, queue/state gauges, latency, SLOs, alerts, synthetics, and load envelopes |
