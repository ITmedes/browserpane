...
| Platform telemetry and SLOs | Partial prototype | Gateway OpenMetrics HTTP RED/runtime capacity merged through PR #222; W3C/OTLP gateway-to-broker lifecycle traces through PR #228; label-free workflow/recording counters through PR #230; #231 adds tested Prometheus recording rules, starter alerts, and runbooks | #178 broader worker/store tracing/metrics, queue/state gauges, latency, calibrated SLOs, dashboards, alert routing, synthetics, and load envelopes |
