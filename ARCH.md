...
- **HTTP API** (`api.rs`, :8932):
  ...
  - `GET /api/v1/browser-contexts` — list owner-scoped browser contexts with visible-session, active-runtime, optional profile-storage, and retention-expiry summary
  - `GET /api/v1/browser-contexts/{id}` — fetch one browser context with visible-session, active-runtime, optional profile-storage, and retention-expiry summary
