...
pub(super) struct InMemorySessionStore {
    ...
    pub(super) extension_definitions: Mutex<Vec<StoredExtensionDefinition>>,
    pub(super) extension_versions: Mutex<Vec<StoredExtensionVersion>>,
    pub(super) file_workspaces: Mutex<Vec<StoredFileWorkspace>>,
    pub(super) file_workspace_files: Mutex<Vec<StoredFileWorkspaceFile>>,
