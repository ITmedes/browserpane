...
async fn run_ffmpeg_session(
    ...
    let tile_thread = tokio::task::spawn_blocking(move || {
        ...
        const MAX_CDP_SCROLL_DY_PX: i64 = scroll::CONTENT_SCROLL_SEARCH_MAX_PX as i64;
        ...
        const SCROLL_RESIDUAL_FULL_REPAINT_RATIO: f32 = scroll::SCROLL_RESIDUAL_FULL_REPAINT_RATIO_DEFAULT;
