...
fn tile_scroll_messages_round_trip() {
    ...
    let stats = TileMessage::ScrollStats {
        ...
        scroll_residual_interior_limit_fallbacks_total: 2,
        scroll_residual_low_saved_ratio_fallbacks_total: 1,
        scroll_residual_large_row_shift_fallbacks_total: 1,
        scroll_residual_other_fallbacks_total: 1,
        scroll_zero_saved_batches_total: 6,
        scroll_split_region_batches_total: 7,
        scroll_sticky_band_batches_total: 3,
        scroll_chrome_tiles_total: 1_234,
        scroll_exposed_strip_tiles_total: 432,
        scroll_interior_residual_tiles_total: 987,
        scroll_edge_strip_residual_tiles_total: 321,
        scroll_small_edge_strip_residual_tiles_total: 210,
        scroll_small_edge_strip_residual_rows_total: 654,
        scroll_small_edge_strip_residual_area_px_total: 12_345,
