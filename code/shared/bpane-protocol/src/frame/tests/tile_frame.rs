...
fn tile_all_variants_via_frame() {
    let messages = vec![
        ...
        TileMessage::ScrollStats {
            ...
            scroll_edge_strip_residual_tiles_total: 4,
            scroll_small_edge_strip_residual_tiles_total: 3,
            scroll_small_edge_strip_residual_rows_total: 12,
            scroll_small_edge_strip_residual_area_px_total: 768,
