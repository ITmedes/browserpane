...
pub enum TileMessage {
    ...
    ScrollStats {
        ...
        scroll_residual_interior_limit_fallbacks_total: u32,
        scroll_residual_low_saved_ratio_fallbacks_total: u32,
        scroll_residual_large_row_shift_fallbacks_total: u32,
        scroll_residual_other_fallbacks_total: u32,
        scroll_zero_saved_batches_total: u32,
        scroll_split_region_batches_total: u32,
        scroll_sticky_band_batches_total: u32,
        scroll_chrome_tiles_total: u32,
        scroll_exposed_strip_tiles_total: u32,
        scroll_interior_residual_tiles_total: u32,
        scroll_edge_strip_residual_tiles_total: u32,
        scroll_small_edge_strip_residual_tiles_total: u32,
        scroll_small_edge_strip_residual_rows_total: u32,
        scroll_small_edge_strip_residual_area_px_total: u32,
