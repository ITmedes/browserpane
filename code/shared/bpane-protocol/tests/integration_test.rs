...
fn tile_pipeline_all_variants() {
    ...
    let stats = TileMessage::ScrollStats {
        ...
        scroll_split_region_batches_total: 50,
        scroll_sticky_band_batches_total: 12,
        scroll_chrome_tiles_total: 300,
        scroll_exposed_strip_tiles_total: 44,
        scroll_interior_residual_tiles_total: 156,
        scroll_edge_strip_residual_tiles_total: 77,
        scroll_small_edge_strip_residual_tiles_total: 55,
        scroll_small_edge_strip_residual_rows_total: 144,
        scroll_small_edge_strip_residual_area_px_total: 9_216,
