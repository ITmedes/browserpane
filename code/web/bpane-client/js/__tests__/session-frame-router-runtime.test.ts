  ...
  it('updates scroll-related tile stats and overlay clearing rules', () => {
    ...
    const handlePayload = vi.fn()
      ...
      .mockReturnValueOnce({
        ...
        scrollEdgeStripResidualTilesTotal: 3,
        scrollSmallEdgeStripResidualTilesTotal: 2,
        scrollSmallEdgeStripResidualRowsTotal: 5,
        scrollSmallEdgeStripResidualAreaPxTotal: 640,
