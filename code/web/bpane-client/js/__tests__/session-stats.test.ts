...
describe('SessionStats host scroll health', () => {
  it('reports rolling host fallback windows from cumulative totals', () => {
    ...
    stats.recordHostScrollStats(0, 0, 0, 0, 0, 0, 0);
    stats.recordHostScrollStats(10, 2, 100, 80, 1, 1, 2);
    stats.recordHostScrollStats(30, 8, 300, 210, 3, 5, 4);
  ...
  it('clears rolling history when host counters reset', () => {
    ...
    stats.recordHostScrollStats(0, 0, 0, 0, 0, 0, 0);
    stats.recordHostScrollStats(12, 3, 120, 90, 1, 2, 3);
    stats.recordHostScrollStats(1, 0, 10, 10, 0, 0, 1);
