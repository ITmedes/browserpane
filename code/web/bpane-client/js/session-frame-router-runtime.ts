    ...
    switch (command.type) {
      ...
      case 'scroll-stats':
        ...
        this.stats.recordHostScrollStats(
          ...
          command.scrollResidualInteriorLimitFallbacksTotal,
          command.scrollResidualLowSavedRatioFallbacksTotal,
          command.scrollResidualLargeRowShiftFallbacksTotal,
          command.scrollResidualOtherFallbacksTotal,
          command.scrollZeroSavedBatchesTotal,
          command.scrollSplitRegionBatchesTotal,
          command.scrollStickyBandBatchesTotal,
          command.scrollChromeTilesTotal,
          command.scrollExposedStripTilesTotal,
          command.scrollInteriorResidualTilesTotal,
          command.scrollEdgeStripResidualTilesTotal,
          command.scrollSmallEdgeStripResidualTilesTotal,
          command.scrollSmallEdgeStripResidualRowsTotal,
          command.scrollSmallEdgeStripResidualAreaPxTotal,
