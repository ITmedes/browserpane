...
describe('admin shell route metadata', () => {
  it.each([
    ...
    [
      '/admin-new/credential-bindings/binding-1',
      'credentials',
    ...
    [
      '/admin-new/workflow-event-subscriptions',
      'events',
      'BrowserPane Workflow Event Subscriptions',
    ],
    [
      '/admin-new/workflow-event-subscriptions/new',
      'events',
      'BrowserPane New Workflow Event Subscription',
    ],
    [
      '/admin-new/workflow-event-subscriptions/subscription-1',
      'events',
      'BrowserPane Workflow Event Subscription Details',
    ],
