      ...
      >
        ...
        >
          <label class="grid gap-1.5 text-sm"
            ><span class="font-medium text-admin-ink">Version</span><input
              ...
              type="text"
              bind:value={versionDraft.version}
              disabled={busy}
              placeholder="1.0.0"
              data-testid="extension-version-value"
            />{#if versionValidation.fieldErrors.version}<AdminMessage
                tone="error"
                density="compact"
                items={versionValidation.fieldErrors.version}
                testId="extension-version-value-error"
              />{/if}</label
          >
          <label class="grid gap-1.5 text-sm"
            ><span class="font-medium text-admin-ink">Installed path</span><input
              ...
              type="text"
              bind:value={versionDraft.installPath}
              disabled={busy}
              placeholder="/opt/browserpane/extensions/example"
              data-testid="extension-version-path"
            />{#if versionValidation.fieldErrors.installPath}<AdminMessage
                tone="error"
                density="compact"
                items={versionValidation.fieldErrors.installPath}
          ...
          <button
            ...
            type="submit"
            disabled={busy || !versionValidation.valid}
