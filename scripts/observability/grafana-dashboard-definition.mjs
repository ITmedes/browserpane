...
export const EXPECTED_PANELS = [
  ...
  { id: 5, title: 'Gateway p95 duration', type: 'timeseries', unit: 's', expr: 'browserpane:gateway_http_request_duration_seconds:p95_rate5m' },
  { id: 6, title: 'Runtime slot utilization', type: 'gauge', unit: 'percentunit', expr: 'browserpane:runtime_capacity_utilization:ratio' },
  ...
  { id: 10, title: 'Produced-file failure ratio', type: 'stat', unit: 'percentunit', expr: 'browserpane:workflow_produced_file_upload_failure:ratio_increase15m' },
  { id: 11, title: 'Produced-file failures', type: 'stat', unit: 'short', expr: 'browserpane:workflow_produced_file_upload_failures:increase15m' },
  { id: 12, title: 'Event delivery success', type: 'stat', unit: 'percentunit', expr: 'browserpane:workflow_event_delivery_success:ratio_increase15m' },
  { id: 13, title: 'Event delivery retries', type: 'stat', unit: 'short', expr: 'browserpane:workflow_event_delivery_retries:increase15m' },
  { id: 14, title: 'Event terminal failures', type: 'stat', unit: 'short', expr: 'browserpane:workflow_event_delivery_failures:increase15m' },
  { id: 15, title: 'Recording finalize success', type: 'stat', unit: 'percentunit', expr: 'browserpane:recording_artifact_finalize_success:ratio_increase15m' },
  { id: 16, title: 'Recording finalize failures', type: 'stat', unit: 'short', expr: 'browserpane:recording_artifact_finalize_failures:increase15m' },
