...
const DEFAULT_REQUIRED_PATHS = [
  ...
  'docs/BPANE-00223_THREAT_MODEL_BASELINE_PLAN.md',
  'docs/COMPOSE_RELIABILITY_BASELINE.md',
  'docs/PRODUCTION_SECURITY_BASELINE.md',
...
const DEFAULT_DOCUMENTED_COMMANDS = [
  ...
  ['AGENTS.md', 'node scripts/check-production-security-baseline.mjs'],
  ...
  ['README.md', 'node scripts/check-production-security-baseline.mjs'],
  ['README.md', 'node scripts/validate.mjs --profile fast'],
  ['docs/VALIDATION_MATRIX.md', 'node scripts/check-production-security-baseline.mjs'],
